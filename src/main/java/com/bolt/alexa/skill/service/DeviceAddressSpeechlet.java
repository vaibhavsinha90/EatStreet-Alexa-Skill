...
public class EatStreetSpeechlet implements Speechlet {
    ...
    private SpeechletResponse getWelcomeResponse() {
        ...
        card.setTitle("You can ask if a restaurant is open or will deliver to your house.");
    ...
    private SpeechletResponse getRestaurantSearchResponse(Intent intent){
        ...
        //Restaurant matchedRestaurant=restaurantSearchService.search(intentSlots.get("restaurant").getValue(),address,defaultRadius,checkDelivery);
        //String showText =matchedRestaurant==null? "Restaurant not found" : matchedRestaurant.getApiKey();
        SimpleCard card = new SimpleCard();
